...
WHERE (FLOAT(trip.pickup_latitude) BETWEEN 40.6994 AND 40.8824)
  ...
  AND (trip.pickup_datetime) BETWEEN "2013-01-',str_pad(i,2,pad = "0"), ' 00:00:00" AND "2013-01-', str_pad(i+1,2,pad = "0"), ' 00:00:00"', sep='')
  data <- query_exec(sql,project, max_pages = Inf)
  write.csv( data,
             paste("data/2013-01-", str_pad(i,2,pad = "0"), ".csv", sep=''))
  print(i)
}
